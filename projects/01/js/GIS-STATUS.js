...
//! AREAS LAYERS
layersProps["project_20m"] = [  true,  "red",  false,  "polygon",  { 6: "Green", 5: "Yellow", 4: "Blue", 3: "Orange", 2: "Brown", 1: "Purple", 0: "Red" },];
layersProps["landsEFR"] = [  true,  "red",  false,  "polygon",  { "NO DELIVERED": "red", "DELIVERED": "green" },];
layersProps["landsUtil"] = [ true, "red", false, "polygon", { "NO DELIVERED": "red", "DELIVERED": "#08f750ff" }, ];
layersProps["landsComp"] = [ true, "red", false, "polygon", { "NO DELIVERED": "red", "DELIVERED": "#42a68bff" }, ];
...
layersProps["acuExis"] = [false, "blue", true, "line", { "RED-MATRIZ-EXIST": "blue", "RED-MENOR-EXIST": "#07ACF4", RETIRAR: "red", "RED-MATRIZ-PROY": "BLUE", "RED-MENOR-PROY": "#07ACF4",}];
layersProps["enelExis"] = [false, "yellow", true, "line"];
layersProps["alcExis"] = [false, "rgb(208, 2, 244)", true, "line", { "PLU": "rgb(124, 36, 171)", "SAN": "rgb(208, 2, 244)", "COM":"rgb(208, 0, 102)"}];
layersProps["etbExis"] = [false, "rgb(6, 250, 112)", true, "line", { "PLU": "rgb(124, 36, 171)", "SAN": "rgb(208, 2, 244)"}];
...
layersProps["acuProy"] = [false, "blue", false, "line", { "RED-MATRIZ-EXIST": "blue", "PROTECCION_TRAMO": "#00ffff", RETIRAR: "red", "RED-MATRIZ-PROY": "BLUE", "RED-MENOR-PROY": "#07ACF4",}];
layersProps["enelProy"] = [false, "yellow", false, "line"];
layersProps["alcProy"] = [false, "rgb(208, 2, 244)", false, "line", { "PLU": "rgb(124, 36, 171)", "SAN": "rgb(208, 2, 244)"}];
...
var acuExis = L.geoJson(null, {
  style: function (feature) {
    return {
      color: layersProps["acuExis"][4][feature.properties.RefName],
      opacity: 1,
      weight: 2,
      dashArray: "3, 3",
      clickable: true,
...
var landsComp = L.geoJson(null, {
  ...
  var project_20m = L.geoJson(null, {
    style: function (feature) {
      return {
        color: layersProps["project_20m"][4][feature.properties.val],
        weight: 3,
        opacity: 1,
      };
    },
    onEachFeature: function (feature, layer) {
      layer.on({
        mouseover: highlightFeature,
        mouseout: function (e) {
          project_20m.resetStyle(e.target);
        },
      });
...
var highlightStyle = {
  ...
  $.getJSON("data/project20.geojson", function (data) { project_20m.addData(data);});
  ...
  map = L.map("map", {
    ...
    zoom: zoom,
    center: [setY, setX],
    layers: [ project_20m, sections, labelsSections, cartoLight, munCFRO,  blueLine, railLine, pks2, projectLine,],
  ...
  //! PERMITS
  registerLazy(bics, "data/bics.geojson");
  registerLazy(bicsRegio, "data/bicsRegio.geojson");
  registerLazy(bicsZI, "data/bicsZI.geojson");
  registerLazy(bicsAreas, "data/bicsAreas.geojson");
    ...
    layer.setIcon(
      L.divIcon({
        html: `<div style='font-size: ${zoomArray(
          zoom
        )}px; -o-transform: rotate(45deg); transform: rotate(${
          labelAngle
  ...
  var overlaysTree = {
    ...
    children: [
      { label: '<div id="onlysel">-Show only selected-</div>' },
        {
        label: "Project Advance (Construction)",
        selectAllCheckbox: true,
        children: [
          { label: "Construction Advance", layer: project_20m, name: "project_20m" },
