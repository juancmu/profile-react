...
layersProps["landsEFR"] = [true, "red", false, "polygon", { "NO DELIVERED": "red", "DELIVERED": "green", "PENDING": "red" },];
...
(() => {
  ...
  map = L.map("map", {
    ...
    zoom: zoom,
    center: [setY, setX],
    layers: [sections, labelsSections, cartoLight, munCFRO, blueLine, railLine, pks2, projectLine],
