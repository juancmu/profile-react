!(function () {
  class Qolor {
    ...
    static fromHSL(e, t, n, r) {
      const i = new Qolor().fromHSL(e, t, n);
    ...
    toHSL() {
      ...
      const e = Math.max(this.r, this.g, this.b),
        ...
        n = e - t,
        r = (e + t) / 2;
      if (!n) return { h: 0, s: 0, l: r };
      const i = r > 0.5 ? n / (2 - e - t) : n / (e + t);
      let o;
      switch (e) {
        case this.r:
          o = (this.g - this.b) / n + (this.g < this.b ? 6 : 0);
          break;
        case this.g:
          o = (this.b - this.r) / n + 2;
          break;
    ...
    fromHSL(e, t, n) {
      ...
      return (
        (e /= 360),
        (this.r = this._hue2rgb(i, r, e + 1 / 3)),
        (this.g = this._hue2rgb(i, r, e)),
        (this.b = this._hue2rgb(i, r, e - 1 / 3)),
        this
      );
    }
    toString() {
        ...
        return 1 === this.a
          ? "#" +
              (
                ...
                .toString(16)
                .slice(1, 7)
          : `rgba(${Math.round(255 * this.r)},${Math.round(
              255 * this.g
  ...
  (Qolor.w3cColors = {
    ...
    "undefined" != typeof module && (module.exports = Qolor);
    ...
    function d(s) {
      var l,
        ...
        h = (function (n) {
          return (
            n +
            a * (1.9148 * t(n) + 0.02 * t(2 * n) + 3e-4 * t(3 * n)) +
            102.9372 * a +
            e
          );
        })(
          (function (e) {
            return a * (357.5291 + 0.98560028 * e);
          })(s)
        );
      return {
  ...
  var earcut = (function () {
        ...
        (x &&
          (v = (function (e, r, i, o) {
            ...
            for (a = 0, s = r.length; a < s; a++)
              (h = r[a] * o),
                (d = a < s - 1 ? r[a + 1] * o : e.length),
                (f = t(e, h, d, o, !1)) === f.next && (f.steiner = !0),
                m.push(c(f));
    ...
    function r(e, t, l, u, c, d, f) {
      if (e) {
        ...
        for (var m, p, x = e; e.prev !== e.next; )
          if (((m = e.prev), (p = e.next), d ? o(e, u, c, d) : i(e)))
            t.push(m.i / l),
              t.push(e.i / l),
              t.push(p.i / l),
              w(e),
    ...
    function i(e) {
      ...
      for (var i = e.next.next; i !== e.prev; ) {
        if (
          d(t.x, t.y, n.x, n.y, r.x, r.y, i.x, i.y) &&
          m(i.prev, i, i.next) >= 0
        )
          return !1;
        i = i.next;
    ...
    function o(e, t, n, r) {
      ...
      for (
        ...
        if (
          x !== e.prev &&
          x !== e.next &&
          d(i.x, i.y, o.x, o.y, a.x, a.y, x.x, x.y) &&
          m(x.prev, x, x.next) >= 0
        )
          return !1;
        x = x.nextZ;
      }
      for (x = e.prevZ; x && x.z >= f; ) {
        if (
          x !== e.prev &&
          x !== e.next &&
          d(i.x, i.y, o.x, o.y, a.x, a.y, x.x, x.y) &&
      ...
      if (
        (t = (function (e, t) {
          ...
          for (; r !== u; )
            i >= r.x &&
              r.x >= h &&
              d(o < c ? i : a, o, h, c, o < c ? a : i, o, r.x, r.y) &&
              ((l = Math.abs(o - r.y) / (i - r.x)) < f ||
                (l === f && r.x > n.x)) &&
              g(r, e) &&
              ((n = r), (f = l)),
              (r = r.next);
    ...
    constructor(e, t) {
      ...
      e.addEventListener("webglcontextlost", (e) => {
        ...
        t ||
          ...
          (n.depthTextureExtension = n.getExtension("WEBGL_depth_texture"))),
        (this.GL = n);
    }
    destroy() {
  ...
  function multiply(e, t, n) {
    ...
    (e[0] = r * y + i * T + o * G + a * D),
      ...
      (e[8] = c * y + d * T + f * G + m * D),
      (e[9] = c * w + d * M + f * _ + m * C),
      (e[10] = c * b + d * L + f * S + m * F),
      (e[11] = c * P + d * E + f * A + m * R),
  ...
  (GLX.Buffer = class {
          ...
          this.useDepthTexture
            ? ((this.depthTexture = new GLX.texture.Image()),
              ...
              GL.texImage2D(
                ...
                0,
                GL.DEPTH_STENCIL,
                GL.depthTextureExtension.UNSIGNED_INT_24_8_WEBGL,
                null
              ),
    ...
    (GLX.Matrix = class {
      ...
      translateTo(e, t, n) {
        return (
          (this.data[12] = e), (this.data[13] = t), (this.data[14] = n), this
        );
      }
      translateBy(e, t, n) {
        return (
    ...
    (GLX.Matrix.transpose3 = (e) =>
      new Float32Array([e[0], e[3], e[6], e[1], e[4], e[7], e[2], e[5], e[8]])),
    ...
    (GLX.Matrix.transform = (e) => {
      const t = e[12],
        ...
        r = e[14],
        i = e[15];
      return { x: (t / i + 1) / 2, y: (n / i + 1) / 2, z: (r / i + 1) / 2 };
    }),
    (GLX.Matrix.invert = (e) => {
  ...
  class Marker {
    constructor(e, t = null, n = {}) {
      ...
      (this.color = Qolor.parse(n.color || Marker.defaultColor).toArray()),
        (this.metersPerLon =
          METERS_PER_DEGREE_LATITUDE * Math.cos((e.latitude / 180) * Math.PI)),
  ...
  class OSMBuildings {
    constructor(e = {}) {
      (APP = this),
        e.style &&
          (e.style.color || e.style.wallColor) &&
        ...
        (this.position = e.position || { latitude: 52.52, longitude: 13.41 }),
        (this.zoom =
          e.zoom || this.minZoom + (this.maxZoom - this.minZoom) / 2),
        (this.rotation = e.rotation || 0),
        (this.tilt = e.tilt || 0);
      const t = Math.min(window.navigator.hardwareConcurrency || 2, 4),
        n = new Blob([workers.feature], { type: "application/javascript" });
      ...
      (this.canvas.width = this.width = 1 * this.domNode.offsetWidth),
        (this.canvas.height = this.height = 1 * this.domNode.offsetHeight),
    ...
    project(e, t, n) {
      ...
      return {
        x: (i = mul3scalar(add3(i, [1, 1, 1]), 0.5))[0] * this.width,
        y: (1 - i[1]) * this.height,
        z: i[2],
      };
    }
    unproject(e, t) {
      ...
      if (void 0 !== i)
        return {
          longitude:
            this.position.longitude + i[0] / METERS_PER_DEGREE_LONGITUDE,
    ...
    addMapTiles(e) {
      return (
        (this.basemapGrid = new Grid(e, BitmapTile, {}, 4)), this.basemapGrid
      );
    }
    highlight(e) {
    ...
    _updateAttribution() {
      ...
      this.attribution && e.push(this.attribution),
        (this._attribution.innerHTML = e.join(" Â· "));
    }
    _getStateFromUrl() {
      ...
      e &&
        ...
        this.setPosition(
          void 0 !== t.lat && void 0 !== t.lon
            ? { latitude: parseFloat(t.lat), longitude: parseFloat(t.lon) }
            : this.position
        ),
  ...
  (OSMBuildings.VERSION = null),
    (OSMBuildings.ATTRIBUTION =
      '<a href="https://osmbuildings.org/">Â© OSM Buildings</a>'),
  ...
  class Events {
    ...
    onMouseUp(e) {
      if (this.isClick) {
        ...
        APP.view.Picking.getTarget(t.x, t.y, (e) => {
          this.emit("pointerup", { features: e.features, marker: e.marker });
        });
      }
    }
    onMouseWheel(e) {
    ...
    moveMap(e) {
      ...
      const t = 0.86 * Math.pow(2, -APP.zoom),
    ...
    rotateMap(e) {
      this.isDisabled ||
        ((this.prevRotation +=
          (e.clientX - this.prevX) * (360 / window.innerWidth)),
        (this.prevTilt -=
          (e.clientY - this.prevY) * (360 / window.innerHeight)),
  ...
  class Grid {
    ...
    update() {
      ...
      r = this.fixedZoom
        ...
        : this.mergeTiles(r, e, 0.5 * TILE_SIZE * TILE_SIZE);
      const i = {};
      r.forEach((t) => {
    ...
    load(e) {
      APP.workers.get((t) => {
        t.onMessage((e) => {
          ...
          t.postMessage({ type: this.type, url: e, options: this.options });
      });
    }
    onLoad(e) {
                  ...
                  (this.texCoordBuffer = new GLX.Buffer(2, e.texCoords)),
                    (this.timer = setTimeout(() => {
                      (this.heightBuffer = new GLX.Buffer(1, e.heights)),
                        (this.timer = setTimeout(() => {
                          (this.pickingBuffer = new GLX.Buffer(
                            3,
                            e.pickingColors
                          )),
                            (this.timer = setTimeout(() => {
  ...
  function getViewQuad(e, t, n) {
    ...
    let i,
      ...
      d = getIntersectionWithXYPlane(-1, 1, r);
    if (u && h)
      return (
        (d && c) ||
          ((l = dot2(
            (i = norm2(sub2((a = getIntersectionWithXYPlane(-1, -0.9, r)), u))),
            n
          )),
          (d = add2(u, mul2scalar(i, t / l))),
          (l = dot2(
            (o = norm2(sub2((s = getIntersectionWithXYPlane(1, -0.9, r)), h))),
            n
          )),
          (c = add2(h, mul2scalar(o, t / l)))),
        dot2(n, sub2(d, u)) > t &&
          ((l = dot2((i = norm2(sub2(d, u))), n)),
          (d = add2(u, mul2scalar(i, t / l)))),
        dot2(n, sub2(c, h)) > t &&
  ...
  function getConvexQuadArea(e) {
    return (
      getTriangleArea(e[0], e[1], e[2]) + getTriangleArea(e[0], e[2], e[3])
    );
  }
  function getTileSizeInMeters(e, t) {
    return (
      (EARTH_CIRCUMFERENCE_IN_METERS * Math.cos((e / 180) * Math.PI)) /
      Math.pow(2, t)
    );
  }
    ...
    setupViewport() {
      ...
      GL.viewport(0, 0, t, n),
        (this.viewMatrix = new GLX.Matrix()
          ...
          .rotateX(APP.tilt)
          .translateBy(0, 8 / e, 0)
          .translateBy(0, 0, -1220 / e)),
        (this.viewDirOnMap = [
          Math.sin((APP.rotation / 180) * Math.PI),
          -Math.cos((APP.rotation / 180) * Math.PI),
        ]);
      const r = 1024 / (2 * Math.tan(0.125 * Math.PI)),
        i = ((2 * Math.atan(n / 2 / r)) / Math.PI) * 180;
      (this.nearPlane = 1),
        (this.farPlane = 3e4),
        (this.projMatrix = new GLX.Matrix()
          .translateTo(0, -n / (2 * e), 0)
          .scale(1, -1, 1)
          .multiply(
            new GLX.Matrix.Perspective(i, t / n, this.nearPlane, this.farPlane)
          )
          .translateBy(0, -1, 0)),
    ...
    findFeatures(e, t, n) {
      ...
      return (
        APP.features.forEach((e) => {
          e.items.forEach((e) => {
            (e.id !== o && e.properties.building !== o) ||
              i.some((t) => t.id === e.id) ||
      ...
      static updateView(e) {
        (this.projMatrix = getCoveringOrthoProjection(
          substituteZCoordinate(e, 0).concat(
            substituteZCoordinate(e, SHADOW_MAP_MAX_BUILDING_HEIGHT)
          ),
          this.viewMatrix,
          1e3,
          7500
    ...
    (View.Buildings = class {
      ...
      render(e) {
        ...
        if (
          ...
          t.setParam("uLightColor", "3fv", [0.5, 0.5, 0.5]),
        ...
        t.setTexture("uWallTexIndex", 0, this.wallTexture),
          ...
          APP.features.forEach((e) => {
            ...
            n &&
              ...
              GL.drawArrays(GL.TRIANGLES, 0, e.vertexBuffer.numItems));
          }),
          t.disable();
      }
      destroy() {}
    ...
    (View.Basemap = class {
      ...
      renderTile(e) {
        const t = this.shader,
          n = new GLX.Matrix();
        n.translateBy(
          (e.longitude - APP.position.longitude) * METERS_PER_DEGREE_LONGITUDE,
          (-e.latitude + APP.position.latitude) * METERS_PER_DEGREE_LATITUDE,
          0
        ),
    ...
    (View.HudRect = class {
      ...
      createGeometry() {
        const e = [],
          t = [];
        return (
          e.push(0, 0, 1e-5, 1, 0, 1e-5, 1, 1, 1e-5),
          e.push(0, 0, 1e-5, 1, 1, 1e-5, 0, 1, 1e-5),
          t.push(0.5, 0.5, 1, 0.5, 1, 1),
          t.push(0.5, 0.5, 1, 1, 0.5, 1),
      ...
      render(e, t, n) {
        ...
        i.setSize(n[0], n[1]),
          ...
          APP.features.items.concat([this.mapPlane]).forEach((t) => {
            ...
            const n = t.getMatrix();
            n &&
              (r.setParam("uFade", "1f", t.getFade()),
              r.setMatrix("uMatrix", "4fv", GLX.Matrix.multiply(n, o)),
              r.setMatrix("uModelMatrix", "4fv", n.data),
              r.setMatrix(
                "uNormalMatrix",
                "3fv",
                GLX.Matrix.transpose3(
                  GLX.Matrix.invert3(GLX.Matrix.multiply(n, e))
                )
              ),
              r.setBuffer("aPosition", t.vertexBuffer),
              r.setBuffer("aNormal", t.normalBuffer),
              r.setBuffer("aZScale", t.zScaleBuffer),
              GL.drawArrays(GL.TRIANGLES, 0, t.vertexBuffer.numItems));
          }),
          r.disable(),
          i.disable(),
          GL.viewport(0, 0, APP.width, APP.height);
      ...
      constructor() {
        (this.shader = new GLX.Shader({
          ...
          (this.vertexBuffer = new GLX.Buffer(
            3,
            new Float32Array([
              -1, -1, 1e-5, 1, -1, 1e-5, 1, 1, 1e-5, -1, -1, 1e-5, 1, 1, 1e-5,
              -1, 1, 1e-5,
            ])
          )),
          (this.texCoordBuffer = new GLX.Buffer(
